...
5. Review all new additions before committing. Remove unsafe files from `emojis/` and do not include them in `dist/`.
6. Rebuild the archive after every accepted import:
...
7. Update the README image count.
